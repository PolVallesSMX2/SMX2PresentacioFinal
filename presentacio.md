   # 📑 Fil Conductor: Defensa del Projecte Intermodular

## 👤 1. Presentació Personal
* **Nom de l'alumne:** Pol Vallès
* **Curs:** 2n de Sistemes Microinformàtics i Xarxes (SMX2)
* **Perfil de GitHub:** [@PolVallesSMX2](https://github.com/PolVallesSMX2)
...
Ens vam incorporar a la consultora fictícia EverPia com a tècnics júnior IT per resoldre necessitats tecnològiques del sector educatiu, aplicant metodologies professionals, l'ús de Markdown i anàlisi de serveis cloud.
...
Fase final de la trilogia de consultoria, centrada en l'autonomia, maduresa professional, gestió de riscos i control de versions avançat (Git col·laboratiu). Es va introduir el disseny digital UX/UI de maquetes d'aplicacions.
* **Productes lliurats (PI):** [P03: Kanban de control final](https://planner.cloud.microsoft/webui/v1/plan/t5W0yFPDsEu4qgckjBqz6ZYAAoFw?tid=c7b5981a-7820-4ac8-ae65-03515ea81317) | [P02: Projecció de la Maqueta d'Aplicació Interactiva (Figma - Find Your Pet)](https://www.figma.com/design/PwMoluDFRgkFMwjtfmGf0Q/Find-Your-Pet-Xavi-Pol?t=pRbf4cWAk29WVjB5-0)
* **Repositori oficial:** [🔗 GitHub - Projecte 4](https://github.com/PolVallesSMX2/P4-EverPia-3-Sobreviure-en-una-empresa-IT/blob/main/README.md)

---

### 💡 Projecte 05 — La Incubadora
Creació d'una startup tecnològica pròpia simulant un entorn real d'acceleradora d'empreses, combinant competències de viabilitat econòmica, comunicació de producte i visió Green IT.
* **Productes lliurats (PI):** [P03: Evidència d'assaig tècnic](https://drive.google.com/file/d/1Wr3-_5fKC3UmHBkO_bsNLRrv1DQo9N-q/view) | [P03: Presentació comercial en format Screencast](https://drive.google.com/file/d/1vu8JWuEyoS8zAC88s09LpkmiNAn3er1S/view?usp=sharing)
* **Repositori oficial:** [🔗 GitHub - Projecte 5](https://github.com/PolVallesSMX2/Projecte-05-La-incubadora)

### 🌐 Projecte 06 — Nexus
Orientat al disseny i desplegament d’una infraestructura de servidors segura i optimitzada per a una plataforma d'E-learning sostenible, comparant l'eficiència de servidors com Apache i Nginx.
* **Productes lliurats (PI):** [P01: Memòria tècnica de la proposta d'infraestructura](https://github.com/classesSMX2n/projecte6-PolVallesSMX2/blob/main/Productes/P01/solucio.md) | [P02: Document d'arquitectura de la solució](https://github.com/classesSMX2n/projecte6-PolVallesSMX2/blob/main/Productes/P02/Presentaci%C3%B3%20Infraestructura%20Nexus.pdf)
* **Repositori oficial:** [🔗 GitHub - Projecte 6](https://github.com/classesSMX2n/projecte6-PolVallesSMX2)

### 🚛 Projecte 07 — Food Logístics S.A.
Modernització tecnològica d’una empresa de distribució logística real, dissenyant solucions d’alta disponibilitat, pressupostos de maquinari, seguretat de dades crítiques i traçabilitat.
* **Producte lliurat (PI):** [P01: Proposta tècnica i dossier de desplegament logístic](https://github.com/classesSMX2n/projecte-7-PolVallesSMX2/tree/main/Productes/P01)
* **Repositori oficial:** [🔗 GitHub - Projecte 7](https://github.com/classesSMX2n/projecte-7-PolVallesSMX2)

### 🌱 Projecte 08 — Connecta’t al Futur: El repte de la digitalització real
Projecte final de síntesi i transformació digital de petites i mitjanes empreses (PIMES). Unificació de conceptes d’automatització avançada amb criteris de sostenibilitat, ODS i administració eficient del sistema estudiat durant el cicle.
